	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item"><a href="view.php" class="nav-link">Send eRx to Hospital</a></li>
...
<center><h1>Search Hospital for sending eRx</h1></center>
<br>
...
<br>
<center><input type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Search by Pincode"></center><br>
<script>
...
if ($result = $mysqli->query("SELECT * FROM hospital_csv" ))
{
...
// set table headers
echo "<tr><th>ID</th><th>NAME</th><th>EMAIL</th><th>ADDRESS</th><th>CITY</th><th>ZIP</th><th>TELEPHONE</th><th>COUNTRY</th><th>STATE_ID</th><th>OWNER</th</tr>";
...
<section>
<center>
<form action ="../erx.php" method = "POST">
Hospital ID: <input type="text" name="hospitalid" placeholder="Enter the Hospital ID">
<button type="submit" value="send">Proceed</button>
</form>
<br></center>
</section>
