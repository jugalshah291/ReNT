...
<center><h1>View all Nurse Records</h1></center>

<center><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search Nurse by Day"></center>
<br>
<script>
function myFunction() {
...
<!--<br><p><b>View All</b> | <a href="view-paginated.php">View Paginated</a></p>
<br>-->
...
if ($result = $DBcon->query("SELECT * FROM `weeksched2` WHERE `H_EMAIL`='$h_email'" ))
{
...
// set table headers
echo "<tr><th>ID</th><th>Day</th><th>Name</th><th>Timefrom</th><th>timeto</th><th>Schedule<th></tr>";
...
echo "<td><a href='nurseerx.php?id=$row->NurseID'>Schedule </a></td></tr>";	
