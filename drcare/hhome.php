...
$xyz = $_SESSION['userSession'];
$email= $DBcon->query("SELECT emailid FROM `hospital_entries` WHERE `user_id` = $xyz");
$abc= $email->fetch_assoc();

$_SESSION['hospital_emailid']=$abc;
    ...
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0"><a href="hospital_logout.php?logout" class="btn btn-secondary py-2 px-3">Logout</a></p>
          ...
          <div class="col-md-4 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
             ...
             <div class="media-body p-2 mt-3">
                <a href="erxtable/view.php"><h3 class="heading">eRX Notification</h3></a>
                <p>Find all the requests for your services at one place</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <a href="nurse_register.php"><h3 class="heading">Register a Nurse</h3></a>
                <p>AProvide your Nurse extra availabilty and we would put it to good use</p>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <a href="viewNurse.php"><h3 class="heading">Confirm Appointments</h3></a>
                <p> Schedule your Nurses for external appointments</p>
              </div>
            </div>      
          </div>
