...
$diknown = strip_tags($_POST['diknown']);
$distype = strip_tags($_POST['distype']);
$ambulation = strip_tags($_POST['ambulation']);
$vision = strip_tags($_POST['vision']);

$methodofcom = strip_tags($_POST['methodofcom']);
$lanofcom = strip_tags($_POST['lanofcom']);
$hearingprob = strip_tags($_POST['hearingprob']);
$Bladdercontrol = strip_tags($_POST['Bladdercontrol']);
$dentures = strip_tags($_POST['dentures']);
    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <div class="heading-section heading-section-white ftco-animate mb-5">
	            ...
	            <h2 class="mb-4">PHR Registration</h2>
...
<br>
                        ...
                        <div class="d-md-flex">
                            <div class="form-group">
                                <input type="type" class="form-control" placeholder="Contact Number" name="contact">
                            </div>
                            </div>
                        <div class="d-md-flex">
                            <div class="form-group">
...
<div class="form-group">
                                <input type="text" class="form-control" placeholder="Ethnicity" name="ethnicity">
                            </div>

<div class="form-group">
                                <input type="text" class="form-control" placeholder="Social Security Pin #" name="sin">
                            </div>
...
<div class="form-group">
                                <input type="text" class="form-control" placeholder="MEDICAID#" name="med">
                            </div>

<div class="form-group">
                                <input type="text" class="form-control" placeholder="Name of Medicaid HMO" name="medhmo">
                            </div>
<div class="form-group">
                                <input type="text" class="form-control" placeholder="HMO ID#" name="hmoid">
                            </div>

<div class="form-group">
                                <input type="text" class="form-control" placeholder="Name of Medicaid HMO Care Manager" name="medcare">
                            </div>

	<h2 class="mb-4">Private Health Insurance</h2>

<div class="form-group">
                                <input type="text" class="form-control" placeholder="Provider" name="provider">
                            </div>
<div class="form-group">
                                <input type="text" class="form-control" placeholder="Insurance ID#" name="insid">
                            </div>
...
<div class="form-group">
                                <input type="text" class="form-control" placeholder="Name of Emergency Contact" name="emergency">
                            </div>
<div class="form-group">
                                <input type="text" class="form-control" placeholder="Contact" name="econtact">
                            </div>
<div class="form-group">
                                <input type="text" class="form-control" placeholder="Address of Emergency Contact" name="eaddress">
                            </div>
<div class="form-group">
                                <input type="text" class="form-control" placeholder="Pincode" name="epincode">
                            </div>

<h2 class="mb-4">Primary Care Physician</h2>

<div class="form-group">
                                <input type="text" class="form-control" placeholder="Name" name="pcpname">
                            </div>
<div class="form-group">
                                <input type="text" class="form-control" placeholder="Contact" name="pcpcontact">
                            </div>

<div class="form-group">
                                <input type="text" class="form-control" placeholder="Address" name="pcpaddress">
                            </div>
<div class="form-group">
                                <input type="text" class="form-control" placeholder="Pincode" name="pcppincode">
                            </div>
...
-->
                        <div class="d-md-flex">
							...
							{
							alert("PHR Registered Successfully");	
