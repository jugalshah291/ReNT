    ...
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
		  ...
		  echo "<p class='button-custom order-lg-last mb-0'><a href='../phome.php?loginid=$loginid' class='btn btn-secondary py-2 px-3'>Back</a></p>";
...
echo "<td>" . $row->chat . "<a href=../chatapp/chat/login.php?loginid=",$loginid," ><img src='chat.svg' width=32 height=16 alt='Chat Now' /></a></td>";
echo "</tr>";
}
