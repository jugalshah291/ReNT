	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a href="videoDoctor.php" class="nav-link">Video Call</a></li>
          ...
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <a href="viewPatient.php"><h3 class="heading">View Personal Health Records</h3></a>
                <p>We provide you with the Personal Health Records of the Patient so you can provide them better care</p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <a href="hospdbs/view.php"><h3 class="heading">Send eRx to Hospital</h3></a>
                <p>We provide hospitals with  e-prescription thus decreasing the time required to prescribe medications and dispense them to patients, and decreasing medication errors.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <a href="chatdoc/login.php"><h3 class="heading">Chat with a Patient</h3></a>
                <p>No matter the time, care will be delivered to the patient.</p>
              </div>
            </div>      
          </div>
		            <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <a href="videoDoctor.php"><h3 class="heading">Video Call</h3></a>
                <p>No matter the time, Live care will be delivered to the patient.</p>
              </div>
            </div>      
          </div>
        </div>
