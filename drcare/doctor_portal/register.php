...
if(isset($_POST['btn-signup'])) {
	...
	if ($count==0) {
		...
		$query = "INSERT INTO doctor_entries(username,email,password,city,pincode,practice_type,erx_facility,teleconsultation) VALUES('$uname','$email','$hashed_password','$city','$pincode','$prac','$erx','$tele')";
...
<div class="signin-form">
	...
	<div class="container">
       ...
       <form class="form-signin" method="post" id="register-form">
        ...
        <h2 class="form-signin-heading">Doctor Registration</h2><hr />
...
<div class="form-group">
        <input type="practice" class="form-control" placeholder="Practice Type ?" name="practice" required  />
        </div>

<div class="form-group">
        <input type="erxfac" class="form-control" placeholder="eRx Facility Provided ?" name="erxfac" required  />
        </div>

<div class="form-group">
        <input type="telecon" class="form-control" placeholder="Teleconsultation Available ?" name="telecon" required  />
        </div>
