<?php
session_start();
include_once 'doctor_connect.php';

if (!isset($_SESSION['userSession'])) {
	header("Location: doctor_register.php");
}

$query = $DBcon->query("SELECT * FROM doctor_entries WHERE user_id=".$_SESSION['userSession']);
    ...
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0"><a href="patient_portal/index.php" class="btn btn-secondary py-2 px-3">Make An Appointment</a></p>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	          ...
	          <li class="nav-item"><a href="doctor_logout.php?logout" class="nav-link">Logout</a></li>
