...
<html>  
  ...
  <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
   ...
   <h3 align="center">Chat with Your Patients</a></h3><br />
   <br />
   
   <div class="table-responsive">
    <h4 align="center">Online Users</h4>
	<p class="button-custom order-lg-last mb-0" >Hello <?php echo $_SESSION['username'];  ?>  <a href="logout.php" class="btn btn-secondary py-2 px-3">Logout</a></p>
