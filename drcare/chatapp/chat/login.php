  ...
  $result = $statement->fetchAll();
    foreach($result as $row)
    {
      if(password_verify($_POST["password"], $row["password"]))
      {
        ...
        header("location:index.php?loginid=".$loginid);
      }
      else
      {
    ...
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0"> <?php
		  echo "<a href=../../phome.php?loginid=",$loginid," class='btn btn-secondary py-4 px-5'>Back</a>"
		  ?></p>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
				<?php
				echo "<a href=login.php?loginid=",$loginid," class='nav-link'>Chat With A Doctor</a></li>";
				?>
